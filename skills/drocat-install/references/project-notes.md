...
- **Existing conda env named `drocat`**: never modify or remove it. Run
  `python skills/drocat-install/scripts/setup_conda_env.py --version 4.4.3` -
  it warns the user and creates a versioned env name (`drocat-v4.4.3`; if
  taken, `drocat-v4.4.3-2`, `-3`, ...), printing the choice as
