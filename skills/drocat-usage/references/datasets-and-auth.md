...
| --- | --- | --- |
| `male-cns:v0.9` | NeuPrint | supported male CNS dataset; local cache may be useful |
| `hemibrain:v1.2.1` | NeuPrint | adult central brain |
| `optic-lobe:v1.1` | NeuPrint | optic-lobe dataset |
| `manc:v1.0` | NeuPrint | male VNC |
| `flywire_FAFB_v783` | FlyWire/CAVE + local files | requires CAVE token and downloaded files |
| `flywire_BANC_v626` | FlyWire/CAVE + local files | requires CAVE token and downloaded files |
