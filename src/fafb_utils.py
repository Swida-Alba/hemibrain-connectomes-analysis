...
def prepare_fafb_data(data_dir):
    ...
    # Use merged files if available (generated by FAFB_file_converter or
    # BANC_file_converter): the parquet is the canonical output; a CSV from
    # an older conversion is still accepted.
    dataset_name = data_path.name
    merged_conn_file = data_path / f'{dataset_name}_merged_connections.parquet'
    if not merged_conn_file.exists():
