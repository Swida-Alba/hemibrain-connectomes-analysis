...
For agent-assisted runs without a web UI, use the
[`drocat-usage` skill](../../skills/drocat-usage/SKILL.md). It tells an agent
to execute the focused script, validate outputs, and finish with a report.
