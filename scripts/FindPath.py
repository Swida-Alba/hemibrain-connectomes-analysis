...
if __name__ == '__main__':
    fc = FindNeuronConnection(
        ...
        sourceNeurons=['L3'],  # pd.read_excel('sourceNeurons.xlsx', header=None).iloc[:,0].tolist()
        targetNeurons=['s-LNv.*_R'],  # pd.read_excel('targetNeurons.xlsx', header=None).iloc[:,0].tolist()
