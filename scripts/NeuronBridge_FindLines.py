...
if __name__ == "__main__":
    ...
    # ==========================================================================
    # Generate PDF summary of downloaded images
    # PDF is automatically generated by find_lines_batch() when images are downloaded
    
    # Images per page: (columns, rows)
    # Default: (5, 3) = 5 columns x 3 rows = 15 images per page
